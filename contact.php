                ...
                <div class="row">
                    <div class="col-md-12">
                        <section>
                            ...
                            <p class="lead">In this website we are going to help you in every way possible, if you have any problems in our product you can contact us in the ways below</p>
                        </section>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="box-simple">
                            ...
                            <p>King Saud University
                                ...
                                <br>Riyadh <strong>Kingdom of Saudi Arabia</strong>
                            </p>
                        </div>
                        <!-- /.box-simple -->
                    </div>
